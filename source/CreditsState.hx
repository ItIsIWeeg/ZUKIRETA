...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Zukireta Team'],
		['Weeg',				'weeg',				'Sprite Artist, Main Programmer, Charter',			'https://twitter.com/ItIsIWeeg',		0xFF7FFFBF],
		['GenoX',				'genox',			'Fukkireta Cover, Background Art', 					'https://twitter.com/GenoXACT2',		0xFFA3ABC8],
		[''],
		['Psych Engine Team'],
